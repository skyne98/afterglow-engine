...
class BlobStorageClient {
  rpc;
  closed = false;
  static async spawn(workerWasmUrl = "blobstorage.wasm", baseUrl = "") {
  ...
  async read(namespace, key, offset, len, maxValueBytes) {
  ...
  async beginPut(namespace, key, totalLen, checksum, maxValueBytes) {
