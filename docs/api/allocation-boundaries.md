...
| Surface detail / POM | `none` hot path | GPU fragment work only; resident height textures allocated at bootstrap | 8–32 bounded layers, 3.25 m fade/cutoff; prewarmed base/POM material references |
