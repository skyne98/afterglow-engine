...
The engine chooses Chromium's `pointerrawupdate` event when available. Unlike a
...
that option, the engine retries ordinary pointer lock. Call it from a click or
